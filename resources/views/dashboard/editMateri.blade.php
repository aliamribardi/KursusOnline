                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="review-content-section">
                                            ...
                                            <div class="mg-b-pro-edt">
                                                <input type="text" name="name" id="name" class="form-control" placeholder="Materi" value="{{ $materi->name }}">
                                            </div>
                                            <div class="mg-b-pro-edt">
                                                <input type="text" name="slug" id="slug" class="form-control" placeholder="slug" value="{{ $materi->slug }}">
                                            </div>                                            
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="text-center custom-pro-edt-ds">
                                            <button type="submit" class="btn btn-ctl-bt waves-effect waves-light m-r-10">Edit Materi
                                                </button>
                                        </div>
                                    </div>
                                </div>
